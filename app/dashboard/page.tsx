...
export default async function Component() {
  ...
  return (
    <>
    <Navbar />
    <DashboardStud showStudInfo={false} showProfName={true} user_data={user_data} user_email={user_email} approvedReviews={approvedReviews} pendingReviews={pendingReviews} />
    </>
  )
}