...
const Sidebar = () => {
    ...
    const toggleLHR =()=>{setIsLHROpen(!isLHROpen); };
    const toggleISLB =()=>{setIsISLBOpen(!isISLBOpen); };
    const toggleFSL =()=>{setIsFSLOpen(!isFSLOpen); };
    const toggleKRC =()=>{setIsKRCOpen(!isKRCOpen); };
    return (
      <aside className="Sidebar">
        <ul className='SidebarUl'>
          <li><button onClick={toggleLHR}>LHR</button>
          ...
          <li><button onClick={toggleISLB}>ISLB</button>
          ...
          <li><button onClick={toggleFSL}>FSL</button>
          ...
          <li><button onClick={toggleKRC}>KRC</button>
