...
export function AddReviewButton({
  ...
  const handleSubmit = async () => {
    ...
    const { success, message, id } = await submitReviewAction(
      rating,
      comment,
      prof_id,
      selectedTags
        ...
        <div className="mx-auto w-full max-w-md">
          {!showTagsPage ? (
            <>
              <DrawerHeader>
                <DrawerTitle>
                  {p_comment === "" ? "Add Review" : "Edit Review"}
                </DrawerTitle>
                <DrawerDescription>
                  Share your thoughts about the professor
                </DrawerDescription>
              </DrawerHeader>
              ...
              <DrawerFooter>
                <Button onClick={() => setShowTagsPage(true)}>
                  Add Tags...(Optional)
                </Button>
