                ...
                filteredReviews.map((review) => (
                    <div key={review.review_id} className="bg-muted rounded-3xl p-4 mb-4">
                        <div className="flex items-center space-x-2 mb-2 justify-between">
                            ...
                            {review.student_email === student_email && <AddReviewButton prof_id={prof_id} p_rating={review.rating} p_comment={review.comment} p_string={review.tag_names} />}
                        </div>
                        ...
                        <div className='flex flex-col  sm:justify-between sm:items-center sm:flex-row'>
                            ...
                            <div className="flex space-x-2">
                                {review.tag_names.length ? review.tag_names.map((tag, index) => {
                                    return (
                                    ...
                                    <Badge className="h-6 hover:pointer cursor-pointer">No Tag!</Badge>
                                )}
                            </div>
                        </div>
                    </div>
