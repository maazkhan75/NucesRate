...
import { ProfessorsPageUrl } from "../types/professors_url_type";
  ...
  export function PaginationProfessors({page_number, url} : {page_number: number, url: ProfessorsPageUrl}) {
    ...
    return (
      <Pagination>
        <PaginationContent>
          ...
          <PaginationItem>
            <PaginationNext href={`/professors/${page_number+1}?${queryParams.toString()}`} />
          </PaginationItem>
        </PaginationContent>
      </Pagination>
    )
