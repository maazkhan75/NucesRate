...
export default function DeptTagAlert({url}: {url: ProfessorsPageUrl}) {
  ...
  if (url.department && url.tag) {
    return (
        <Alert>
          ...
          <AlertTitle className={styles.alert_box}>
            <span>Department & Tag Filter Applied for : {url.department} & {url.tag}</span>
            <HoverCard>
              <HoverCardTrigger>
                <IoIosCloseCircle onClick={removeFilters} className={styles.cross} />
              </HoverCardTrigger>
              <HoverCardContent>
                <span  className="text-xs text-muted-foreground">Remove Both Filter!</span>
              </HoverCardContent>
            </HoverCard>
          </AlertTitle>
        </Alert>
    ...
    return (
        <Alert>
          ...
          <AlertTitle className={styles.alert_box}>
            ...
            <HoverCard>
              <HoverCardTrigger>
                <IoIosCloseCircle onClick={removeDeptFilter} className={styles.cross} />
              </HoverCardTrigger>
              <HoverCardContent>
                <span  className="text-xs text-muted-foreground">Remove Department Filter!</span>
              </HoverCardContent>
            </HoverCard>
          </AlertTitle>
        </Alert>
    ...
    return <Alert>
        ...
        <HoverCard>
            <HoverCardTrigger>
            <IoIosCloseCircle onClick={removeTagFilter} className={styles.cross} />
            </HoverCardTrigger>
            <HoverCardContent>
            <span  className="text-xs text-muted-foreground">Remove Tag Filter!</span>
            </HoverCardContent>
        </HoverCard>
        </AlertTitle>
    </Alert>
